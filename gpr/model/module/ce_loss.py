...
# https://github.com/Dao-AILab/flash-attention/blob/9a11f440d3a34f618b4ba814c825b109c6d7e8f5/flash_attn/ops/triton/cross_entropy.py#L284
...
class FlashCrossEntropyLoss(nn.Module):
    ...
    def forward(self, input, target):
        ...
        loss, z_losses = cross_entropy_loss(
            input,
            target,
